...
console.log( `O resultado da soma é: ${sum(resultado)}` ); // O resultado da soma é 7
// ?
...
*/
const resultSub = (a, b) => a - b;
console.log( `O resultado da subtração é: ${sum(resultSub}` );
// ?
const resultMult = (a, b) => a * b;
console.log( `O resultado da multiplicação é: ${sum(resultMult}` );
// ?
const resultDiv = (a, b) => a / b;
console.log( `O resultado da divisão é: ${sum(resultDiv}` );
// ?
const restoDiv = (a, b) => a % b;
console.log( `O resto da divisão é: ${sum(restoDiv}` );
// ?
