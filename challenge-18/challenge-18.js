(function (){
  ...
  */
  ...
  console.log(clearCpf('049-214 3421-1')); //04921434211
  console.log(clearCpf('21045852205')); //21045852205
  console.log(clearCpf('735 500 794 - 22')); //73550079422
  console.log(clearCpf('101.123-131x32')); //10112313132
  ...
  */
  ...
  function cpfMask(cpf) {
    return cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g, (_, n1, n2, n3, n4) => {
      return `${n1}.${n2}.${n3}-${n4}`;
    });
  }
  console.log(cpfMask('04921434211')) //049.214.342-11
  console.log(cpfMask('21045852205')) //210.458.522-05
  console.log(cpfMask('73550079422')) //735.500.794-22
  console.log(cpfMask('10112313132')) //101.123.131-32
  ...
  */
  ...
  console.log(frase.replace(/<(\w+)>(.*?)<\/\1>/g,
