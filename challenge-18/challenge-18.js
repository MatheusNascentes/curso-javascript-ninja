...
*/
  ...
  var phraseRegex = phrase.match(/junho|julho/g);
  console.log(phraseRegex);
...
*/
  ...
  var emptyTag = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
  var emptyTagRegex = emptyTag.match(/(<\w+><\/\w+>)/g);
  console.log(emptyTagRegex);
  /*
...
*/
  ...
  var textRegex = text.replace(/<(\w+)>([^<]+)<\/\1>/g, `<$1>O texto dentro da tag "$1" é "$2"</$1>\n`);
