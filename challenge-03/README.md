...
*/
nomeCompleto(); // Olá! Meu nome é Matheus Nasecentes!
...
pessoa.apresentacao = function () {
  ...
  if (pessoa.idade === 1)
    frase += `tenho ${pessoa.idade} ano, ${pessoa.altura}, meu peso é ${pessoa.peso} e, só hoje, eu já caminhei `;
  else
    frase += `tenho ${pessoa.idade} anos, ${pessoa.altura}, meu peso é ${pessoa.peso} e, só hoje, eu já caminhei `;
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //Olá, eu sou o Matheus Nascentes, tenho 38 anos, 1.75, meu peso é 100 e, só hoje, eu já caminhei 10 metros!
```
