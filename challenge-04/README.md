...
para o contrário.
*/
var isTruthy = function truthy(arg1){
...
carro.adicionarPessoas = function(numeroPessoas){
    ...
    if (totalPessoas > carro.assentos){
        ...
        var plural = quantidadeDePessoasQueCabem === 1 ? "pessoa" : "pessoas";
        return "Só cabem mais" + quantidadeDePessoasQueCabem + " " + plural + "!";
    }
...
carro.quantidadePessoas -= 4; // Agora temos 2 pessoas no carro
