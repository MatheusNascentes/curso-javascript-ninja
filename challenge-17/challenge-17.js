...
*/
  ...
  var textName = text.replace(/Manuel Marques de Sousa/g, "Luiz Fellipe");
...
*/
  ...
  var textCity = textName.replace(/brasileiro/, "capixaba");
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/, function (nickname) {
