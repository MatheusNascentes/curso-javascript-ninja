...
*/
  ...
  var sudeste = ["Espirito Santo", "Rio de Janeiro", "São Paulo", "Minas Gerais"];
...
*/
  ...
  brasil.unshift("Amapá", "Amazonas", "Roraima");
  console.log(brasil);
...
*/
  ...
  var maisDeSete = brasil.every(function (estado) {
...
*/
  ...
  var ceara = brasil.forEach(function (estado) {
    if (estado === "Ceará") {
      ceara = true;
    }
  });
