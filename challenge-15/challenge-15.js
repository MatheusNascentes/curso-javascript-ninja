(function () {
  ...
  */
  ...
  console.log(`${matheus.getFullName()} agora tem ${matheus.addAge(5).getAge()} anos`) //Matheus Nascentes tem 40 anos
  console.log(`${francine.getFullName()} agora tem ${francine.addAge(8).getAge()} anos`) //Francine Campos tem 40 anos
  console.log(`${pedro.getFullName()} agora tem ${pedro.addAge(2).getAge()} anos`) //Pedro Nascentes tem 70 anos
