...
var operation = {
  ...
  */
  function showOperationMessage(op, num1, num2){
    return `A operação ${num1} ${op} ${num2} = ${calculator(op)(num1,num2)}`
  }
  ...
  */
  ...
  var operationSignal = '+';
  var result = showOperationMessage(operationSignal, number1, number2);
  console.log(result); //A operação 20 + 10 = 30
  /*
  ...
  */
  var operationSignal = '-';
  var result = showOperationMessage(operationSignal, number1, number2);
  console.log(result); //A operação 20 - 10 = 10

  var operationSignal = '*';
  var result = showOperationMessage(operationSignal, number1, number2);
  console.log(result); //A operação 20 * 10 = 200

  var operationSignal = '/';
  var result = showOperationMessage(operationSignal, number1, number2);
  console.log(result); //A operação 20 / 10 = 2

  var operationSignal = '%';
  var result = showOperationMessage(operationSignal, number1, number2);
  console.log(result); //A operação 20 % 10 = 0
  ...
  */
  var operationSignal = '&';
  var result = showOperationMessage(operationSignal, number1, number2);
  console.log(result); //Operação & não permitida
});
